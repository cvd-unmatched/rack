...
export function DeviceLibrary() {
  ...
  const open = mobilePanel === 'library';
  ...
  return (
    <>
      ...
      <div
        className={`print:hidden z-50 flex w-64 shrink-0 flex-col border-r border-zinc-800 bg-[#19191c] lg:static lg:z-auto lg:flex ${
          open ? 'fixed inset-y-0 left-0' : 'hidden'
        }`}
      >
